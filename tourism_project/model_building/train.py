...
Xtrain_path = "hf://datasets/ravikmrg6/Tourism-pkg-prediction/Xtrain.csv"
Xtest_path = "hf://datasets/ravikmrg6/Tourism-pkg-prediction/Xtest.csv"
ytrain_path = "hf://datasets/ravikmrg6/Tourism-pkg-prediction/ytrain.csv"
ytest_path = "hf://datasets/ravikmrg6/Tourism-pkg-prediction/ytest.csv"
...
numerical_features = ['Age', 'CityTier',
...
preprocessor = make_column_transformer(
    ...
    (OneHotEncoder(handle_unknown='ignore'), categorical_features) # Changed LabelEncoder to OneHotEncoder
)
...
# Save the model locally
    model_path = "Tourismpkg_prediction_v1.joblib"
    ...
    repo_id = "ravikmrg6/Tourism-pkg-prediction"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="Tourismpkg_prediction_v1.joblib",
        path_in_repo="Tourismpkg_prediction_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
